...
import com.example.appmo.Order.OrderAdapter;
 ...
 */
public class RoomCheckIndex extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_index_order_state, container, false);
        showToolBar();
    ...
    private void showToolBar() {
        ...
        if (actionBar != null) {
            actionBar.setTitle(getString(R.string.order) + "  " + corruntDate);
    ...
    private void recicleViewOrder() {
        ...
        recyclerView = view.findViewById(R.id.recyclerViewBreadState);
    ...
    private void loadWebService() {
        ...
        String url = "http://" + ip + "/appmo/listOrderState.php";
