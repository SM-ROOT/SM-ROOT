 ...
 */
public class RouteIndex extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    private static ManagerFragmentRoute state;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_index_route, container, false);
        recicleViewOrder();
        loadWebService();
        showToolBar();
        backButton();
    ...
    private void recicleViewOrder() {
        ...
        recyclerView = view.findViewById(R.id.recyclerViewRoute);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itemAdd:
                changeFragment(ManagerFragmentRoute.ROUTE_ADD);
                break;
