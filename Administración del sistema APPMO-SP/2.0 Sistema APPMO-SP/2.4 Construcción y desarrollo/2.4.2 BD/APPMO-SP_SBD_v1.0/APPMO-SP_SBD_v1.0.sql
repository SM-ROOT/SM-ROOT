...
-- Volcando datos para la tabla appmo.appmo_client: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_orderproduct: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_order_orderproduct: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_purchase: ~18 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_purchasematerial: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_purchase_purchasematerial: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_route: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_sale: ~105 rows (aproximadamente)
...
INSERT INTO `appmo_store` (`idBread`, `name`, `type`, `quantity`) VALUES
	(1, 'sdfe', 'ds', 'ds');
...
-- Volcando datos para la tabla appmo.appmo_supply: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla appmo.appmo_user: ~2 rows (aproximadamente)
