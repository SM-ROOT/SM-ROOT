...
$json=array();
    ...
    if(isset($_GET["name"]) && isset($_GET["destination"]) && isset($_GET["date"]) ) {
		...
		$insert="INSERT INTO appmo_order (appmo_order.nameClient, appmo_order.destination, appmo_order.date)
		VALUES ('{$name}', '{$destination}', '{$date}')";
